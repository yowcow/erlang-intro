...
partition_list_smaller_than_or_equal_to_pivot_test_() ->
    {Smaller, Larger} = quicksort:partition(4, [4], [1,2,3], [6,7,8]),
    [   ?_assertEqual([4,1,2,3], Smaller),
        ?_assertEqual([6,7,8], Larger)].

partition_list_larger_than_pivot_test_() ->
    {Smaller, Larger} = quicksort:partition(4, [5], [1,2,3], [6,7,8]),
    [   ?_assertEqual([1,2,3], Smaller),
        ?_assertEqual([5,6,7,8], Larger)].
